...
class Stock extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, section_id, params', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'section' => array(self::BELONGS_TO, 'StockSection', 'section_id'),
			'stockHistories' => array(self::HAS_MANY, 'StockHistory', 'stock_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'name' => 'Name',
			'section_id' => 'Связь с массивом из php',
