...
/**
 * This is the model class for table "RegionCity".
 *
 * The followings are the available columns in table 'RegionCity':
 * @property string $id
 * @property string $region_id
 * @property string $name
 * @property string $lat
 * @property string $lon
 * @property string $count_people
 *
 * The followings are the available model relations:
 * @property Region $region
 */
class RegionCity extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, region_id, name, lat, lon, count_people', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('count_people',$this->count_people,true);
	 ...
	 * @return RegionCity the static model class
	 */
