...
class Region extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'ports' => array(self::HAS_MANY, 'Region2Transport', 'region_id', 'condition' => 'type = "port"'),
            'airports' => array(self::HAS_MANY, 'Region2Transport', 'region_id', 'condition' => 'type = "air"'),
            'stations' => array(self::HAS_MANY, 'Region2Transport', 'region_id', 'condition' => 'type = "railway"'),
            'banks' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "bank"'),
            'businessBanks' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "business_bank"'),
            'orgs' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "organization"'),
            'companies' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "company"'),
            'developmentInstitutes' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "development_institute"'),
            'planingInfrastructs' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "planing_infrastruct"'),
            'greatSchools' => array(self::HAS_MANY, 'Region2Company', 'region_id', 'condition' => 'type = "great_school"'),
