<div class="col-xs-12">
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'investment_climate', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'investment_banking', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'investment_support_structure', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'investment_regional', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
