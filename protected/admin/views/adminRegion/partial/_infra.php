<div class="col-xs-12">
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_social_object', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_health', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_communal', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_education', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_sport', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_transport', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_trade', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_organiation_turnover', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
    ...
    <div class="form-group">
        ...
        <div
            class="col-xs-12 col-sm-8"><?php echo $form->textArea($model->content, 'infra_assets_deprication', array('rows' => 6, 'cols' => 50, 'class' => 'rte')); ?>
