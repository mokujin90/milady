<script type="text/javascript">
    ...
    function wsf_item_<?php echo str_replace(array('[',']'), '', $field)?>(data, settings){
        var $container = settings.add_button.closest('div');
        $container.remove('.delete-media-button');
        $container.find('.open-dialog').after('<input class="delete-media-button btn" type="button" value="Удалить"/>');
