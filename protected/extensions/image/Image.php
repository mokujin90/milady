...
class Image {
    ...
    {
        if (!($this->driver instanceof Image_ImageMagick_Driver)) {
            throw new CException('strip not implemented');
        }
        $status = $this->driver->strip($this->image['file']);
