            ...
            <div class="main-column opacity-box">
                ...
                <div class="row">
                    <div class="inner-column">
                        ...
                        <div class="main-company-info chain-block">
                            ...
                            <div class="text">
                                ...
                                if (!empty($attr)):?>
                                    <div class="caption notice"><?= $project->getAttributeLabel('contact_face') ?>:
                                    </div>
                                ...
                                if (!empty($attr)):?>
                                    <div class="caption notice"><?= $project->getAttributeLabel('contact_role') ?>:
                                    </div>
                                    <div class="value"><?= $attr ?></div>
                                <?php endif; ?>
                                <?php
                                ...
                                if (!empty($attr)):?>
                                    <div class="caption notice"><?= $project->getAttributeLabel('contact_address') ?>:
                                    </div>
                                    <div class="value"><?= $attr ?></div>
                                <?php endif; ?>
                                <?php
                                ...
                                if (!empty($attr)):?>
                                    <div class="caption notice"><?= $project->getAttributeLabel('contact_phone') ?>:
                                    </div>
                                    <div class="value"><?= $attr ?></div>
                                <?php endif; ?>
                                <?php
                                ...
                                if (!empty($attr)):?>
                                    <div class="caption notice"><?= $project->getAttributeLabel('contact_email') ?>:
                                    </div>
                                    <div class="value"><?= $attr ?></div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="inner-column two">
                        ...
                        <div
                            class="name"><?= $project->type != Project::T_SITE ? $project->name : $tmp[$project->{Project::$params[$project->type]['relation']}->site_type] ?></div>
                    ...
                    <div class="row display-1000" style="margin-left: 18px;">
                        ...
                        <? foreach ($project->lastNews as $newsItem): ?>
                            <div class="news-info chain-block">
                                ...
                                <div class="text">
                                    <div
                                        class="caption notice"><?= Candy::formatDate($newsItem->create_date, 'd.m.Y / H:m') ?></div>
                                    <div
                                        class="value"><?= CHtml::link(CHtml::encode($newsItem->announce), $newsItem->createUrl()) ?></div>
                                </div>
                            </div>
                        <? endforeach ?>
                        <br>
