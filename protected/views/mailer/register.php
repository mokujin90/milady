                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <p style="margin: 1em 0;">
                                            ...
                                            <?=Mail::link('user/confirm',array('id'=>$params['model']->id,'hash'=>$params['model']->hash()))?>
                                            <br>
                                            Ссылка действует 1 раз и в течении суток. После активации вы сможете зайти под своим логином\паролем.
                                        </p>
                                    </td>
                                </tr>
                                </tbody></table>
