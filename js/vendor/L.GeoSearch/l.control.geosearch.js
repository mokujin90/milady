    ...
    _showLocation: function (location) {
        if (this.options.showMarker == true) {
            if (typeof this._positionMarker === 'undefined'){
                ...
                mapJs._setCords({lat: this._positionMarker._latlng.lat,lon: this._positionMarker._latlng.lng});
            }
            else
                this._positionMarker.setLatLng([location.Y, location.X],{draggable:true});
        }
