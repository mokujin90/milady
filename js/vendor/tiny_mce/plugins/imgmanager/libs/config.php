...
if($_SESSION['session_id'] && $_SESSION['user_auth']){
    $auth = true;
    //require_once 'EncriptDecript.php';
...
// WEB BASE DIRECTORY
defined('WEB_BASE') || define('WEB_BASE', 'data/tinymce' );


//UPLOAD PATH
defined('UPLOADS_PATH')
        || define('UPLOADS_PATH', realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.WEB_BASE));
